...
import (
	"github.com/deuuus/bmsru-rsoi-lab2/src/loyalty/internal/handlers"
...
func main() {
	...
	if err != nil {
		logrus.Fatalf("Failed to start Loyalty service on port %s", port)
	}
	logrus.Infof("Loyalty service is listening on port %s", port)
}
